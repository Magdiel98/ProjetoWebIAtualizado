...
function cadastro()
{
    ...
    let dados = {
        emailc: email, 
        nomec: nome,
        sobrenomec: sobrenome,
        sexoc: sexo,
        nascimentoc: nascimento, 
        cpfc: cpf,
        telefonec: telefone,
        celularc: celular,
        ruac: rua, 
    ...
    firebase.auth().createUserWithEmailAndPassword(
        ...
        cadastroBanco(dados, response.user.uid)
        fetch(`https://usuario-a8e40-default-rtdb.firebaseio.com/usuario/${response.user.uid}.json`)
        .then(() => {
    ...
    .catch(error => {
        alert("Erro ao tentar fazer cadastro!" + error);
    })

}


function cadastroBanco(dados, id)
{
    fetch(`https://usuario-a8e40-default-rtdb.firebaseio.com/usuario/${id}.json`, {
        method:'PATCH', 
        headers: {
